/**
  ...
  $Revision: 38483 $
  $Date: 2015-02-08 17:36:25 +0100 (sø, 08 feb 2015) $
  
  FORKID {AE2102AB-B86A-4aa7-8E9B-F0B6935D4E9F}
*/

description = "Fab Lab Oulu CNC";
vendor = "Autodesk, Inc.";
...
function onOpen() {
  ...
  writeBlock(gPlaneModal.format(90));
}
...
function onClose() {
  ...
  if (properties.useG28 && !machineConfiguration.hasHomePositionX() && !machineConfiguration.hasHomePositionY()) {
    ...
    writeBlock(gFormat.format(53), "Z0", mFormat.format(5));
    writeBlock(gFormat.format(53), "X25 Y1000");
  }
